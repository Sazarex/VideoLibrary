namespace WinFormsVideoLibrary
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            button1.TabIndex = 0;
            button1.Text = "Библиотека фильмов и сериалов";
            ...
            // button3
            // 
            button3.Location = new Point(13, 66);
            button3.Name = "button3";
            button3.Size = new Size(170, 48);
            button3.TabIndex = 2;
            button3.Text = "Контроль подписок";
            button3.UseVisualStyleBackColor = true;
            button3.Click += button3_Click;
            // 
            // button4
            // 
            button4.Location = new Point(189, 66);
            button4.Name = "button4";
            button4.Size = new Size(117, 48);
            button4.TabIndex = 3;
            button4.Text = "Режиссеры";
